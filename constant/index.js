...
export const mainLeading = [
  { id: "1", month: "1 Month", pay: "$230", img: "/main_lead1.png", url: "/" },
  { id: "2", month: "3 Months", pay: "$685", img: "/main_lead2.png", url: "/" },
  {
    id: "3",
    month: "6 Months",
    pay: "$1,370",
...
export const mainEducationProgram = [
  { id: "1", month: "1 Month", pay: "$150", img: "/main_edu1.png", url: "/" },
  { id: "2", month: "3 Months", pay: "$455", img: "/main_edu2.png", url: "/" },
  { id: "3", month: "6 Months", pay: "$910", img: "/main_edu3.png", url: "/" },
  {
    id: "4",
    month: "12 Months",
    pay: "$1,820",
...
export const coinList = [
  {
    id: "1001",
    description: "Coin trading program (Program fee separate)",
    month: "1 Month",
    pay: "$390",
    shopping: "E-mail",
...
export const stockList = [
  {
    id: "1001",
    description: "Stock trading program (Program fee separate)",
    month: "1 Month",
    pay: "$390",
    shopping: "E-mail",
...
export const lectureList = [
  {
    id: "1001",
    description: "Stock + Coin leading operation (Program fee separate)",
    month: "1 Month",
    pay: "$230 ",
    shopping: "E-mail",
...
export const leadingList = [
  {
    id: "1001",
    description: "Operation of stock coin education services and programs (education $152+program $380)",
    month: "1 Month",
    pay: "$532",
    shopping: "E-mail",
  ...
  {
    id: "1002",
    description: "Operation of stock coin education services and programs (education $455+program $1,137)",
    month: "3 Months",
    pay: "$1,592",
    shopping: "E-mail",
  ...
  {
    id: "1003",
    description: "Operation of stock coin education services and programs (education $910+program $2,275)",
    month: "6 Months",
    pay: "$3,185",
    shopping: "E-mail",
  ...
  {
    id: "1004",
    description: "Operation of stock coin education services and programs (education $1,820+program $4,545)",
    month: "12 Months",
    pay: "$6,365",
    shopping: "E-mail",
...
export const lectureEducation = [
  {
    items: [
      {
        id: "01",
        title: "기초 교육",
        description: "주식투자 기초: 투자의 기초적인 개념등을 교육합니다.",
      },
      {
        id: "02",
        title: "기술적 분석 기초",
        description: "차트 패턴, 기술 지표 등 기술적 분석의 기초를 교육합니다.",
      },
      {
        id: "03",
        title: "시장 개념",
        description:
          "주식시장의 구조, 주요 플레이어들, 트레이딩 및 투자 스타일 (예: 일일 트레이딩, 스윙 트레이딩, 장기 투자)에 대한 이해를 제공합니다.",
      },
      {
        id: "04",
        title: "자산 분석",
        description: "기본적인 경제 지표, 재무제표 해석, 기술적 분석의 주요 지표 및 도구 등을 교육합니다.",
      },
      {
        id: "05",
        title: "중급 및 고급 교육",
        description: "전략 개발 및 백테스팅: 투자 전략의 개발과 백테스팅 방법을 교육합니다.",
      },
      {
        id: "06",
        title: "리스크 관리",
        description: "투자자들이 리스크를 어떻게 관리해야 하는지에 대한 교육을 제공합니다.",
      },
      {
        id: "07",
        title: "실시간 트레이딩 워크샵",
      ...
      },
      {
        id: "09",
        title: "케이스 스터디",
        description: "실제 시장 사례를 분석하며 학습하는 세션을 제공합니다.",
      },
    ],
    lectureEdu: [
      {
    ...
    communicate: [
      {
        mainTitle: "커뮤니티 및 네트워킹",
        title: "포럼 및 디스커션 그룹",
        description1:
          "투자자들이 온라인 포럼이나 디스커션 그룹에서 질문을 하고, 의견을 나눌 수 있는 플랫폼을 제공합니다.",
        title2: "워크샵 및 네트워킹 이벤트",
        description2: "주기적으로 워크샵이나 네트워킹 이벤트를 개최하여, 투자자들이 전문가들과 연결될 수 있게 합니다.",
      },
    ],
    library: [
      {
      ...
      },
      {
        ...
        description: "시장 분석, 자산 분석, 트렌드 보고서 등 다양한 리서치 리포트를 제공합니다.",
      },
      {
        title: "도구 및 소프트웨어",
        ...
        description: "투자자들이 사용할 수 있는 투자 도구 및 소프트웨어를 제공합니다.",
      },
    ],
    mentoning: [
      {
        title: "개인화된 멘토링",
        img: "https://images.unsplash.com/photo-1522881193457-37ae97c905bf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80",
        description: "투자 전문가가 투자자의 개인적인 투자 목표와 전략을 논의하고 개선할 수 있는 세션을 제공합니다.",
      },
      {
        title: "포트폴리오 리뷰",
    ...
    mentoWarring: [
      {
        title: "경고 및 주의사항",
        description:
          "모든 투자에는 위험이 있으며, 자금을 잃을 가능성이 있다는 것을 인식해야 합니다. 본 사이트에서 제공하는 모든 정보는 투자판단의 참고자료이며, 서비스 이용에 따른 투자의 최종 책임은 이용자 본인에게 있습니다.",
      },
    ],
  },
];
export const StockEducation = [
  {
    Tech: [
      {
        title: "이동 평균선 (Moving Averages)",
        description1:
      ...
      },
      {
        ...
        description1: "정의: 이 지표는 이동 평균선과 표준 편차를 기반으로 하며, 주가의 변동성을 측정합니다.",
        description2: "활용: 주가가 밴드의 상단을 넘어서면 과매수 상태, 하단을 넘어서면 과매도 상태로 판단합니다.",
      ...
      },
      {
        ...
        description1: "정의: MACD는 두 개의 이동 평균선(단기 및 장기)의 차이를 통해 추세의 강도와 방향을 평가합니다.",
        description2: "활용: MACD 라인이 신호 라인을 상향 돌파하면 매수 신호로, 하향 돌파하면 매도 신호로 해석합니다.",
      ...
      },
      {
        ...
        description2: "활용: RSI 값이 70을 초과하면 과매수, 30 미만이면 과매도 상태로 판단합니다.",
      ...
      {
        title: "캔들스틱 패턴",
        description1: "정의: 캔들스틱 차트는 각 캔들이 특정 시간 동안의 가격 움직임을 나타냅니다.",
        description2: "활용: 특정 캔들스틱 패턴(예: 도지, 해머)을 통해 시장 반전 또는 지속 가능성을 예측합니다.",
  ...
  },
  {
    Fundamental: [
      {
        title: "재무제표 분석",
        description1: "정의: 재무제표 분석은 기업의 재무 상태와 수익성을 평가하는 과정입니다.",
        description2: "활용: 재무제표를 통해 기업의 성장성, 수익성, 안정성 등을 평가하고, 이를 투자 결정에 반영합니다.",
        img: "https://images.unsplash.com/photo-1560221328-12fe60f83ab8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1474&q=80",
      },
      {
        title: "Bollinger Bands",
  ...
  },
  {
    Fundamental: [
      ...
      {
        title: "경제 지표",
        description1: "정의: 경제 지표는 국가의 경제 건전성을 평가하는 다양한 통계자료입니다.",
        description2: "활용: 경제 지표를 통해 전반적인 경제 상황을 파악하고, 이에 따른 시장 반응을 예측합니다.",
        img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80",
      },
      {
        title: "기업 뉴스 및 이벤트",
        ...
        description2: "활용: 뉴스 및 이벤트를 통해 기업의 가치 변동을 예측하고, 투자 전략을 조정합니다.",
        img: "https://www.fxcorporate.com/help/MS/NOTFIFO/IMG/IndicatorDescriptions/MACD_Indicator.png",
      },
    ],
  },
  {
    Market: [
      {
        title: "거래량 분석",
        description1: "정의: 거래량 분석은 주식의 거래량 변화를 통해 시장의 강도나 약점을 평가하는 방법입니다.",
        description2:
    ...
    Risk: [
      {
        ...
        description2: "활용: 개인의 위험 허용 범위에 따라 적절한 포트폴리오를 구성하고, 손실 한도를 설정합니다.",
        img: "https://images.unsplash.com/photo-1560221328-12fe60f83ab8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1474&q=80",
      },
      {
        title: "손절 및 이익 실현 전략",
        description1: "정의: 시장의 변동성에 대비하여 손절 및 이익 실현 전략을 세우는 것은 투자의 중요한 부분입니다.",
        description2:
  ...
  },
  {
    Programing: {
      Run: [
        {
          title: "프로그램 실행",
          description1: "시장의 변동에 따라 자동으로 주문을 생성하고 실행합니다.",
          description2: "단 모든 거래는 회원님의 동의하에 진행되기 때문에 매일 로그인 및 본인 인증을 하셔야 합니다.",
          description3: "리스크 관리: 총 자본금 대비 포지션의 리스크를 설정하고, 손실을 방지하기 위한 기능이 있습니다.",
          img: "https://images.unsplash.com/photo-1560221328-12fe60f83ab8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1474&q=80",
        },
      ],
      Feature: [
        {
          title: "주요 특징",
          description1: "시간 절약: 사용자는 시장을 지속적으로 모니터링할 필요가 없습니다.",
          description2:
            "감정 제거: 알고리즘이 정의된 규칙에 따라 거래를 수행하기 때문에 감정이 거래에 영향을 미치지 않습니다.",
          description3: "고속 거래: 프로그램은 사람보다 훨씬 빠르게 거래를 실행할 수 있습니다.",
      ...
      Install: [
        {
          title: "사용 설명서: 설치 및 설정",
          description1: "프로그램 설치: 필요한 소프트웨어와 라이브러리를 설치합니다.",
          description2:
      ...
      TradingMainTain: [
        {
          title: "거래",
          description1:
            "시뮬레이션 및 백테스팅: 설정한 전략을 이용해 과거 데이터에 대한 백테스팅과 실시간 시뮬레이션을 수행합니다. 실시간 거래: 프로그램을 실시간 거래 모드로 설정하고 거래를 시작합니다.",
          description2: "모니터링 및 조정: 프로그램의 성능을 모니터링하고 필요에 따라 전략을 조정합니다",

          img: "https://images.unsplash.com/photo-1560221328-12fe60f83ab8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1474&q=80",
        },
        {
          title: "유지보수",
          description1: "업데이트 및 최적화: 프로그램을 정기적으로 업데이트하고 최적화하여 성능을 유지합니다.",
          description2: "리스크 관리: 프로그램의 리스크 관리 기능을 이용하여 포지션과 자금을 안전하게 관리합니다.",
